<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
    ...
    <div style="background: white; padding: 30px; border: 1px solid #e0e0e0;">
        ...
        <p>Agradecenis tu participación en la denuncia de hechos irregulares. Tu denuncia ha sido recibida correctamente en nuestro sistema.</p>
        ...
        <ol style="color:#555; line-height: 1.8;">
            ...
            <li>Puedes consultar el estado en cualquier momento usando tu folio</li>
        </ol>
