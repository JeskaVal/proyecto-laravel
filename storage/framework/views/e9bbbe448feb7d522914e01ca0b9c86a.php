    ...
    <div style="background: white; padding: 30px; border: 1px solid #e0e0e0;">
        ...
        <div style="background: #f0f7ff; padding: 15px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul style="margin: 10px 0; padding-left: 20px;">
                <li><strong>Asunto:</strong> <?php echo e($denuncia->titulo_denuncia); ?></li>
                <li><strong>Fecha de Recepción:</strong> <?php echo e($denuncia->fecha_recibida->format('d/m/Y H:i')); ?></li>
        ...
        <div style="text-align: center; margin: 30px 0">
            <a href="<?php echo e($acuse_url); ?>" style="display: inline-block; background: #667eea; color: white; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: 600;">
...
<?php /**PATH C:\Users\Smith\Desktop\DSyOPS\proyecto-laravel\resources\views/emails/denuncia-recibida.blade.php ENDPATH**/ ?>